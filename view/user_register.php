<div class="container">
  ...
  <form method="post" class="rt-register">
    <label class="text-muted" for="rt-email">Email: </label><input value="<?= $email ?>" placeholder="Email-Addresse" class="form-control" id="rt-email" name="rt-email" type="email" onchange="emLength()"><br>
